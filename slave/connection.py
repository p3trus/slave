...
be used to talk to gpib devices. But they lack a consistent interface.

E.g::

    from slave.connection import UsbtmcDevice

    # connect to a tektronix tds2012C mountet at `/dev/usbtmc0`.
    TDS2012C = UsbtmcDevice(0)
...
class GpibDevice(Connection):
    ...
    :param board: The gpib board index.
